...
{
    public partial interface IPictureAppService
    {
        /// <summary>
        ...
        List<string> GetPictureUrls(string pictureIds,
            int targetSize = 0,
        ...
        PagedResultDto<Picture> GetPictures(int pageIndex = 0, int pageSize = int.MaxValue);
