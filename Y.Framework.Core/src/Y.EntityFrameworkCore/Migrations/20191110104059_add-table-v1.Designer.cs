...
namespace Y.Migrations
{
    ...
    [Migration("20191110104059_add-table-v1")]
    partial class addtablev1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Y.Core.Cities", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Y.Core.JobSeeker", b =>
                {
                    b.HasOne("Y.Core.Experience", "Experience")
                        .WithMany()
                        .HasForeignKey("ExperienceId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Y.Core.Knowledge", "Knowledge")
                        .WithMany()
